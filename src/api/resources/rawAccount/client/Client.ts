...
export declare namespace RawAccount {
    interface Options {
...
export class RawAccount {
    constructor(private readonly options: RawAccount.Options) {}

    public async get(request: Venice.GetRawAccount = {}): Promise<Venice.RawAccount[]> {
        const {
            id,
            sourceId,
            standard,
        ...
        const _response = await core.fetcher({
            url: urlJoin(this.options.environment, "/raw_account"),
            method: "GET",
            headers: {
                Range: range,
        ...
        if (_response.ok) {
            return await serializers.rawAccount.get.Response.parseOrThrow(
                _response.body as serializers.rawAccount.get.Response.Raw,
    ...
    public async create(request: Venice.CreateRawAccount): Promise<void> {
        ...
        const _response = await core.fetcher({
            ...
            queryParameters: _queryParams,
            body: await serializers.RawAccount.jsonOrThrow(_body),
        });
        if (_response.ok) {
            return;
        }
    ...
    public async delete(request: Venice.DeleteRawAccount = {}): Promise<void> {
    ...
    public async update(request: Venice.UpdateRawAccount): Promise<void> {
        const {
            id,
            sourceId,
            standard,
